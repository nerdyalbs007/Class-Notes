...
const resources = {
  ...
  url: 'https://firebasestorage.googleapis.com/v0/b/classnotes-27610.appspot.com/o/MCC%2FBirth%20Certificate.pdf?alt=media&token=3fcb61aa-f0b6-4dfa-bec8-9b54fb528cfa',
  // base64: 'JVBERi0xLjMKJcfs...',
};
const AllFiles1 = ({ navigation }) =>{
     ...
     // const source = {uri:'https://arxiv.org/pdf/1708.04439.pdf',cache:true};
      ...
      <View style={{ flex: 1 }}>
          {/* Some Controls to change PDF resource */}
            <Paragraph>
            Important Certificate for UNIT TEST 2
          </Paragraph>
          <PDFView
